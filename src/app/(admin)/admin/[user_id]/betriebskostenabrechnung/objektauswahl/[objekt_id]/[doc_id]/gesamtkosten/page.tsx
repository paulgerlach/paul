...
import AdminGesamtkostenBuildingForm from "@/components/Admin/Forms/DocPreparing/Gesamtkosten/Admin/AdminBuildingForm";
  ...
  return (
    <div className="py-6 px-9 h-[calc(100dvh-77px)] max-h-[calc(100dvh-77px)] max-xl:h-[calc(100dvh-53px)] max-xl:max-h-[calc(100dvh-53px)] grid grid-rows-[auto_1fr]">
      <Breadcrumb
        ...
        link={`${ROUTE_ADMIN}/${user_id}${ROUTE_BETRIEBSKOSTENABRECHNUNG}/objektauswahl/${objekt_id}/abrechnungszeitraum`}
