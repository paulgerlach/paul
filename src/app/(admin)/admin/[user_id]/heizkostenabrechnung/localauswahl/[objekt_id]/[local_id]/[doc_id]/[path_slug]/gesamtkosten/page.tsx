...
export default async function GesamtkostenPage({
  ...
  const { objekt_id, local_id, doc_id, path_slug, user_id } = await params;
  ...
  const backLink = path_slug === "manuell" ? `${ROUTE_ADMIN}/${user_id}${ROUTE_HEIZKOSTENABRECHNUNG}/localauswahl/${objekt_id}/${local_id}/abrechnungszeitraum` : `${ROUTE_ADMIN}/${user_id}${ROUTE_HEIZKOSTENABRECHNUNG}/localauswahl/${objekt_id}/${local_id}/${doc_id}/${path_slug}/dokumentenmanagement`;
