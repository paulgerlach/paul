...
import GesamtkostenLocalFrom from "@/components/Admin/Forms/DocPreparing/GesamtkostenLocalFrom";
  ...
  return (
    <div className="py-6 px-9 h-[calc(100dvh-77px)] max-h-[calc(100dvh-77px)] max-xl:h-[calc(100dvh-53px)] max-xl:max-h-[calc(100dvh-53px)] grid grid-rows-[auto_1fr]">
      <Breadcrumb
        ...
        link={`${ROUTE_BETRIEBSKOSTENABRECHNUNG}/localauswahl/${objekt_id}/${local_id}/abrechnungszeitraum`}
      ...
      <CreateDocContentWrapper>
        <GesamtkostenLocalFrom objektId={objekt_id} localId={local_id} />
