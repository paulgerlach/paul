...
export default async function GesamtkostenPage({
  ...
  params: Promise<{ objekt_id: string; local_id: string; doc_id: string; path_slug: string }>;
}) {
  const { objekt_id, local_id, doc_id, path_slug } = await params;
  ...
  const backLink = path_slug === "manuell" ? `${ROUTE_HEIZKOSTENABRECHNUNG}/localauswahl/${objekt_id}/${local_id}/${doc_id}/${path_slug}/abrechnungszeitraum` : `${ROUTE_HEIZKOSTENABRECHNUNG}/localauswahl/${objekt_id}/${local_id}/${doc_id}/${path_slug}/dokumentenmanagement`;
