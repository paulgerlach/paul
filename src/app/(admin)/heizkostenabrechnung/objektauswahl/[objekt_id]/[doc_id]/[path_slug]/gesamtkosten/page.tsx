...
export default async function GesamtkostenPage({
  ...
  const backLink = path_slug === "manuell" ? `${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/${objekt_id}/abrechnungszeitraum` : `${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/${objekt_id}/${doc_id}/${path_slug}/dokumentenmanagement`;
