...
export default async function GesamtkostenEditPage({
  ...
  const backLink = path_slug === "manuell" ? `${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/weitermachen/${doc_id}/abrechnungszeitraum` : `${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/weitermachen/${doc_id}/${path_slug}/detailansicht`;
