...
export default function GeraetePage() {
  return (
    <main id="content">
      ...
      <Eigenschaften />
      <ChessSection />
      <div className="pl-[100px] max-large:px-16 max-medium:px-10 max-small:px-5 py-16 max-small:py-10 pr-[60px] max-medium:pr-10 max-small:pr-5">
        <div className="bg-[#EFEDEC] rounded-base grid grid-cols-2 gap-20 max-large:grid-cols-1 max-large:p-16 max-medium:p-10 max-small:p-5 px-[72px] pt-[92px] pb-[57px]">
          ...
          <div className="space-y-6">
            ...
            <Link
              className="flex items-center justify-center transition hover:opacity-80 text-white text-center text-lg max-small:text-base cursor-pointer py-5 max-small:py-4 px-[104px] max-medium:w-full max-medium:text-center max-medium:px-0 w-fit rounded-halfbase bg-green"
