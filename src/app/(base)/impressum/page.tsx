	...
	return (
		<main id="content">
			<div className="pt-4 pb-16 px-36 max-large:px-30 max-medium:px-16 max-small:px-5">
				...
				<p className="text-lg text-dark_text">Heidi Systems GmbH</p>
				<p className="text-lg text-dark_text">Monbijoupl. 4</p>
				<p className="text-lg text-dark_text">10178 Berlin</p>
				<br />
				<p className="text-lg text-dark_text">
					Telefon: <Link href="tel:+493052001352">+49 30 52001352</Link>
				</p>
				<p className="text-lg text-dark_text">
					E-Mail:
				...
				<br />
				<p className="text-lg text-dark_text">Vertreten durch: Paul Gerlach</p>
				...
				<div className="space-y-16">
					...
					<div className="space-y-5">
						...
						<p className="text-dark_text text-lg">
							Die Informationen stellt die Heidi Systems GmbH ohne jegliche
					...
					<div className="space-y-5">
						...
						<p className="text-dark_text text-lg">
							...
							genannten Marken gesetzlich geschützte Marken der Heidi Systems
							GmbH oder ihrer Tochterunternehmen.
						</p>
					</div>
				</div>
			</div>
