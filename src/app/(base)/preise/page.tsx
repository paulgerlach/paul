    ...
    <main id="content">
      ...
      <div className="px-20 max-large:px-16 max-medium:px-10 max-small:px-5 my-16 max-small:my-8">
        <div className="grid mb-32 large:mb-24 max-medium:mb-12 hero-1 grid-cols-3 gap-12 max-large:gap-8 items-start max-medium:grid-cols-1 justify-center">
          <div className="space-y-5 max-medium:flex max-medium:flex-col max-medium:items-center max-medium:justify-start">
          ...
          <div className="space-y-5 max-medium:hidden max-medium:flex-col max-medium:items-center max-medium:justify-start">
            <span className="circleIcon inline-block">
              <Image
                width={0}
                height={0}
