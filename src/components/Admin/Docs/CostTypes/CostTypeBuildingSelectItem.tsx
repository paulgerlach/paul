...
export default function CostTypeBuildingSelectItem({
  ...
  return (
    <div className={`bg-white flex items-center justify-between max-medium:flex-col max-medium:items-center max-medium:gap-3 py-3 max-medium:py-2 border-b border-gray-100`}>
