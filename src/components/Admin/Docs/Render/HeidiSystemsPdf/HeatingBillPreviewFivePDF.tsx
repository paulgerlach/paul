...
const styles = StyleSheet.create({
  ...
  classificationTableInnerRow: {
    flexDirection: 'row',
  },
  classificationTableInnerCell: {
    padding: 4,
    textAlign: 'center',
    flex: 1,
  },
...
const HeatingBillPreviewFivePDF = () => {
  const co2Data = [
  ...
  return (
    ...
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.headerText}>5/6 355703/0010</Text>
      ...
      <View style={{ fontSize: 9, marginBottom: 15 }}>
        ...
        <View style={styles.table}>
          ...
          <View
            style={[styles.tableRow, { color: "#2563EB", fontWeight: "bold" }]}
          >
      ...
      <Text style={styles.paragraph}>
        ...
        Heizkostenabrechnung noch nicht berücksichtigt. Im Falle einer
        Vermietung dieser Nutzeinheit ist gemäß CO2KostAufG noch die
        Kostenübernahme durch den Vermieter in Höhe von 14,08 € zu leisten.
      </Text>
      ...
      <View style={styles.qrCodeSection}>
        <View style={styles.qrCodePlaceholder}></View>
        <Text>
          Informationen rund um das Thema CO2-Kostenaufteilung finden Sie unter{" "}
          <Text style={styles.link}>www.brunata-metrona.de/co2</Text>.
        </Text>
      </View>
    </Page>
    // </Document>
...
export default HeatingBillPreviewFivePDF;
