	...
	return (
		<Page size="A4" style={styles.page}>
				...
				<View style={styles.headerMain}>
					...
					<View style={styles.headerMainCol}>
						<View style={styles.heidiAddress}>
							<Text>Heidi Systems GmbH · Monbijoupl. 4 · 10178 Berlin</Text>
						</View>
				...
				<View style={styles.table}>
					...
					<View style={styles.tableRow}>
						...
						<Text
							style={[styles.tableCell, { width: "25%", textAlign: "right" }]}
						>
							{ub.heatingDevicesTotalFormatted} {ub.heatingConsumptionUnit}
						</Text>
						<Text style={[styles.tableCell, { width: "5%" }]}>x</Text>
						<Text
							style={[styles.tableCell, { width: "25%", textAlign: "right" }]}
						>
							{ub.heatingConsumptionCalc.split(" x ")[1] ??
								ub.heatingConsumptionCalc}
						</Text>
						<Text
							style={[styles.tableCell, { width: "5%", textAlign: "right" }]}
						>
				...
				<View style={styles.table}>
					<View style={styles.tableRow}>
						...
						<Text
							style={[styles.tableCell, { width: "25%", textAlign: "right" }]}
						>
							{ub.warmWaterBaseCostCalc.split(" x ")[1] ??
								ub.warmWaterBaseCostCalc}
						</Text>
						<Text
							style={[styles.tableCell, { width: "5%", textAlign: "right" }]}
						>
					...
					<View style={styles.tableRow}>
						...
						<Text
							style={[styles.tableCell, { width: "25%", textAlign: "right" }]}
						>
							{ub.warmWaterConsumptionCalc.split(" x ")[1] ??
								ub.warmWaterConsumptionCalc}
						</Text>
						<Text
							style={[styles.tableCell, { width: "5%", textAlign: "right" }]}
						>
			...
			<View style={styles.section}>
				...
				<View wrap={false}>
					<Text style={styles.costTableTitle}>
						Heizung in {ub.heatingConsumptionUnit}
					</Text>
					<View style={styles.consumptionTable}>
						<View style={styles.consumptionThead}>
							...
							<Text style={[styles.consumptionTh, { flex: 1 }]}>
								ANF.-STAND
							</Text>
						...
						<View style={styles.consumptionTbody}>
							...
							<View style={styles.consumptionSumRow}>
								...
								<Text style={{ flex: 1 }}>
									{ub.heatingDevicesTotalFormatted}
								</Text>
							</View>
						</View>
					</View>
					...
					<View style={styles.consumptionTable}>
						...
						<View style={styles.consumptionTbody}>
							...
							<View style={styles.consumptionSumRow}>
								...
								<Text style={{ flex: 1 }}>
									{ub.warmWaterDevicesTotalFormatted}
								</Text>
							</View>
						</View>
					</View>
					...
					<View style={styles.consumptionTable}>
						...
						<View style={styles.consumptionTbody}>
							...
							<View style={styles.consumptionSumRow}>
								...
								<Text style={{ flex: 1 }}>
									{ub.coldWaterDevicesTotalFormatted}
								</Text>
							</View>
						</View>
					</View>
