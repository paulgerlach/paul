        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text
              style={[
                styles.tableCell,
                { width: "33%", textAlign: "center", color: "#2563EB" },
              ]}
            >
              92,9 kWh / m²
            </Text>
      ...
      <View style={{ fontSize: 9, marginBottom: 15 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
          ...
          <Text style={{ flex: 1 }}>
            ...
            finden Sie unter{" "}
            <Text style={styles.link}>www.brunata-metrona.de/ida</Text>.
            <Text>\n\n</Text>
            ...
            <Text style={styles.link}>www.energieagenturen.de</Text>.
          </Text>
        </View>
      </View>

      <View style={{ fontSize: 8, color: "#6B7280", lineHeight: 1.3 }}>
...
export default HeatingBillPreviewSixPDF;
