...
const styles = StyleSheet.create({
  ...
  tableRowBg: { backgroundColor: "#DDE9E0", paddingVertical: 2 },
  totalRow: {
      ...
      <View style={styles.costBreakdown}>
        ...
        <View style={styles.tableContainer}>
          <View style={styles.table}>
            <Text
              style={{ fontWeight: "bold", marginBottom: 5, color: "#083123" }}
            >
            ...
            <View style={styles.tableRow}>
              <Text style={styles.tableCell}>
                Rechnung{String.fromCharCode(10)}260002673166
              </Text>
          ...
          <View style={styles.table}>
            ...
            <View style={[styles.tableRow, styles.tableRowBg]}>
              <Text
                style={[
                  styles.tableCell,
                  { fontWeight: "bold", paddingLeft: 5, color: "#083123" },
                ]}
              >
              ...
              <Text
                style={[
                  styles.tableCellRight,
                  { fontWeight: "bold", paddingRight: 5, color: "#083123" },
                ]}
              >
                115.498,07 €
              </Text>
