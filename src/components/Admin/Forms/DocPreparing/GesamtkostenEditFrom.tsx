...
export default function GesamtkostenEditForm({
  objektId,
  localId,
  docId,
    ...
    <div className="bg-[#EFEEEC] border-y-[20px] border-[#EFEEEC] col-span-2 rounded-2xl px-4 flex items-start justify-center">
      <div className="bg-white py-16 max-xl:py-6 overflow-y-auto h-full pb-4 px-[18px] rounded w-full shadow-sm space-y-8">
        ...
        <div className="flex items-center justify-between">
          <Link
            href={`${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/weitermachen/${docId}/abrechnungszeitraum`}
          ...
          <Link
            href={`${ROUTE_HEIZKOSTENABRECHNUNG}/objektauswahl/weitermachen/${docId}/umlageschlussel`}
