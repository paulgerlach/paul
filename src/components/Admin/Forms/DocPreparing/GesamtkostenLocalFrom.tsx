...
export default function GesamtkostenLocalFrom({
  objektId,
  localId,
}: {
  objektId: string;
    ...
    <div className="bg-[#EFEEEC] border-y-[20px] border-[#EFEEEC] max-h-[70%] overflow-y-auto col-span-2 rounded-2xl px-4 flex items-start justify-center">
      <div className="bg-white py-16 pb-4 px-[18px] rounded w-full shadow-sm space-y-8">
        ...
        <div className="flex items-center justify-between">
          <Link
            href={`${ROUTE_BETRIEBSKOSTENABRECHNUNG}/localauswahl/${objektId}/${localId}/abrechnungszeitraum`}
          ...
          <Link
            href={`${ROUTE_BETRIEBSKOSTENABRECHNUNG}/localauswahl/${objektId}/${localId}/umlageschlussel`}
