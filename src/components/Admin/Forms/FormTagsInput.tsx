        ...
        <FormItem className="space-y-4 pb-2.5 border-b border-dark_green/20">
          <FormControl>
            <input
              ...
              className="w-8/12 max-medium:w-full block px-[30px] py-4 max-xl:py-2 max-xl:px-4 max-medium:px-3 max-medium:py-2 text-sm border border-dark_green bg-[#757575]/20 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:border-green focus:ring-green"
            />
          </FormControl>
