...
export default function AdminObjekteItemDocWithHistory({
  item,
  isOpen,
  index,
  onClick,
        ...
        {relatedOpenedDocuments?.map((doc) => (
          <div className="flex items-center justify-between" key={doc.id}>
            <Link
              ...
              href={`${ROUTE_ADMIN}/${user_id}${ROUTE_BETRIEBSKOSTENABRECHNUNG}/objektauswahl/weitermachen/${doc.id}/abrechnungszeitraum`}
            >
              <Image
                width={0}
                height={0}
