...
export default function ObjekteItemDocWithHistoryHeader({
  ...
  return (
    <Wrapper
      {...wrapperProps}
      className="w-full rounded-2xl max-medium:rounded-xl p-5 max-medium:p-3 bg-white cursor-pointer flex items-center justify-start gap-8 max-medium:gap-3"
    >
      ...
      {hasDocuments && (
        <Image
          ...
          sizes="100vw"
          loading="lazy"
          className={`max-w-2.5 max-h-4 transition-all duration-300 max-medium:self-start ${
