...
export default function AdminAddBetriebskostenabrechnungCostTypeDialog() {
  const { openDialogByType, closeDialog } = useDialogStore();
  const isOpen =
    openDialogByType.admin_cost_type_betriebskostenabrechnung_create;
  ...
  return (
    <DialogBase dialogName={"admin_cost_type_betriebskostenabrechnung_create"}>
      ...
      <Form {...methods}>
        <form
          ...
          id="admin_cost_type_betriebskostenabrechnung_create-dialog-form"
          onSubmit={methods.handleSubmit(async (data) => {
            try {
              ...
              router.refresh();
              closeDialog("admin_cost_type_betriebskostenabrechnung_create");
            } catch {
