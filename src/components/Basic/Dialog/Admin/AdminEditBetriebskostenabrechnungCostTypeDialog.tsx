...
export default function AdminEditBetriebskostenabrechnungCostTypeDialog() {
  const { openDialogByType, closeDialog, itemID } = useDialogStore();
  const { documentGroups } = useBetriebskostenabrechnungStore();
  const isOpen = openDialogByType.admin_cost_type_betriebskostenabrechnung_edit;
  ...
  return (
    <DialogBase dialogName={"admin_cost_type_betriebskostenabrechnung_edit"}>
      ...
      <Form {...methods}>
        <form
          ...
          id="admin_cost_type_betriebskostenabrechnung_edit-dialog-form"
          onSubmit={methods.handleSubmit(async (data) => {
            try {
              ...
              router.refresh();
              closeDialog("admin_cost_type_betriebskostenabrechnung_edit");
            } catch {
