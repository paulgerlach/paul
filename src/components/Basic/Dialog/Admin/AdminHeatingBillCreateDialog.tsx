...
export default function AdminHeatingBillCreateDialog() {
  const { openDialogByType, closeDialog } = useDialogStore();
  const router = useRouter();
  const isOpen = openDialogByType.admin_heating_bill_create;
  ...
  if (isOpen)
    return (
      <DialogBase size={768} dialogName="admin_heating_bill_create">
