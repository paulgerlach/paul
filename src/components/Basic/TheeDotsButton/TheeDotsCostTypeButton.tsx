      ...
      <PopoverContent
        ...
        {!!userID && (
          <button
            ...
            className="text-xl text-dark_green cursor-pointer flex items-center justify-start gap-2 disabled:opacity-50 disabled:pointer-events-none hover:bg-green/20 transition-all duration-300 px-1.5 py-1 rounded-md">
