          ...
          {items.map((item, index) => (
            <SwiperSlide
              ...
              <div className="swiper-controllers max-medium:hidden">
                <div
                  className={`numbered-item-swiper-pagination-${classNames[index]}-first swiper-pagination`}></div>
                <div
                  className={`numbered-item-swiper-pagination-${classNames[index]}-second swiper-pagination`}></div>
              </div>
            </SwiperSlide>
          ))}
        </div>
