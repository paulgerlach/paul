...
import { locals, heating_bill_documents, objekte, operating_cost_documents, contracts, contractors, local_meters, invoice_documents, users_in_auth, users } from "./schema";
