...
export const useDialogStore = create<DialogStoreType>((set) => ({
	...
	openDialogByType: {
		...
		heating_bill_path_create: false,
		heating_bill_path_delete: false,
		heating_bill_path_edit: false,
		admin_heating_bill_path_create: false,
		admin_heating_bill_path_delete: false,
		admin_heating_bill_path_edit: false,
		login: false,
		register: false,
		...
		admin_ai_invoice_delete: false,
		admin_ai_invoice_edit: false,
		admin_ai_invoice_create: false,
		ai_invoice_create: false,
		ai_invoice_edit: false,
		ai_invoice_delete: false,
	},
